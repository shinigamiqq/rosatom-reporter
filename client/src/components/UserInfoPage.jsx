...
function UserInfoPage() {
  ...
  return (
    <div className="p-6 pt-40 relative">
      ...
      <input name="id" placeholder="Табельный номер" value={userInfo.id} onChange={handleChange} className="block w-full mb-4 p-2" />
      ...
      <input name="rang" placeholder="Ранг" value={userInfo.rang} onChange={handleChange} className="block w-full mb-4 p-2" />
